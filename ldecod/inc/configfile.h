...
Mapping Map[] = {
    ...
    {"CoefFile",                  &cfgparams.coeffile,                      1,   0.0,                       0,  0.0,              0.0,             FILE_NAME_SIZE, },
    {"CoefFile_b",                &cfgparams.coeffile_b,                      1,   0.0,                       0,  0.0,              0.0,             FILE_NAME_SIZE, },
    {"CoefFile_r",                &cfgparams.coeffile_r,                      1,   0.0,                       0,  0.0,              0.0,             FILE_NAME_SIZE, },
    {"MV_File",                  &cfgparams.mvfile,                      1,   0.0,                       0,  0.0,              0.0,             FILE_NAME_SIZE, },
    {"VPF_data",                  &cfgparams.mbfile,                      1,   0.0,                       0,  0.0,              0.0,             FILE_NAME_SIZE, },
    {"MB_data",                  &cfgparams.mbinfo,                      1,   0.0,                       0,  0.0,              0.0,             FILE_NAME_SIZE, },
    ...
    {"DCT_quant",                &cfgparams.idctquant,                    0,   0.0,                       1,  0.0,              1.0,                             },
    {"MV_flag",                   &cfgparams.mv_flag,                      0,   0.0,                       1,  0.0,              1.0,                             },
    {"Chroma",                   &cfgparams.ichroma,                      0,   0.0,                       1,  0.0,              1.0,                             },
    {"Details",                   &cfgparams.idetails,                      0,   0.0,                       1,  0.0,              1.0,                             },
    {"IFrames",                   &cfgparams.iiframes,                      0,   0.0,                       1,  0.0,              1.0,                             },
