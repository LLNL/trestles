...
{ int	reset;				       //  introduced to help keep track of global frame display order bsb 3/21/16
  int   disp_order;			       //  display order bsb 3/21/2016
  int   frame_ctr;
  int   previous_frame;			       // bsb 4/6/2016 keep track of frame order
  int   sframe_ctr;
  int   prev_max;
...
typedef struct inp_par
{
  ...
  char coeffile[FILE_NAME_SIZE];
  char coeffile_b[FILE_NAME_SIZE];
  char coeffile_r[FILE_NAME_SIZE];
  char mvfile[FILE_NAME_SIZE];
  char smbfile[FILE_NAME_SIZE];
  char mbfile[FILE_NAME_SIZE];
  char mbinfo[FILE_NAME_SIZE];
