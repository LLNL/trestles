...
void ParseCommand(InputParameters *p_Inp, int ac, char *av[])
{
  ...
  *p_Inp = cfgparams;
  ...
  while (CLcount < ac)
  {
    ...
    else if (0 == strncmp (av[CLcount], "-cof", 4) || 0 == strncmp (av[CLcount], "-COF", 4))  // A file parameter?
    {
      strncpy(p_Inp->coeffile, av[CLcount+1], FILE_NAME_SIZE);
      CLcount += 2;
    } 
    else if (0 == strncmp (av[CLcount], "-cofb", 5) || 0 == strncmp (av[CLcount], "-COFB", 5))  // A file parameter?
    {
      strncpy(p_Inp->coeffile_b, av[CLcount+1], FILE_NAME_SIZE);
      CLcount += 2;
    } 
    else if (0 == strncmp (av[CLcount], "-cofr", 5) || 0 == strncmp (av[CLcount], "-COFR", 5))  // A file parameter?
    {
      strncpy(p_Inp->coeffile_r, av[CLcount+1], FILE_NAME_SIZE);
      CLcount += 2;
    } 
    else if (0 == strncmp (av[CLcount], "-mv", 3) || 0 == strncmp (av[CLcount], "-MV", 2))  // A file parameter?
    {
      strncpy(p_Inp->mvfile, av[CLcount+1], FILE_NAME_SIZE);
      CLcount += 2;
    } 
    else if (0 == strncmp (av[CLcount], "-mb", 3) || 0 == strncmp (av[CLcount], "-MB", 2))  // A file parameter?
    {
      strncpy(p_Inp->mbfile, av[CLcount+1], FILE_NAME_SIZE);
      CLcount += 2;
    } 
 	else if (0 == strncmp (av[CLcount], "-mbi", 3) || 0 == strncmp (av[CLcount], "-MBI", 3))  // A file parameter?
    {
      strncpy(p_Inp->mbfile, av[CLcount+1], FILE_NAME_SIZE);
      CLcount += 2;
    } 
    ...
    else if (0 == strncmp (av[CLcount], "-dct", 4) || 0 == strncmp (av[CLcount], "-DCT", 4))  // A file parameter?
    {
      conf_read_check (sscanf(av[CLcount+1],"%d", &p_Inp->idctquant), 1);
      CLcount += 2;
    }
    else if (0 == strncmp (av[CLcount], "-det", 4) || 0 == strncmp (av[CLcount], "-DET", 4))  // A file parameter?
    {

      conf_read_check (sscanf(av[CLcount+1],"%d", &p_Inp->idetails), 1);
      CLcount += 2;
    }
    else if (0 == strncmp (av[CLcount], "-if", 2) || 0 == strncmp (av[CLcount], "-IF", 2))  // A file parameter?
    {
      conf_read_check (sscanf(av[CLcount+1],"%d", &p_Inp->iiframes), 1);
      CLcount += 2;
    }
    else if (0 == strncmp (av[CLcount], "-c", 2) || 0 == strncmp (av[CLcount], "-C", 2))  // A file parameter?
    {

      conf_read_check (sscanf(av[CLcount+1],"%d", &p_Inp->ichroma), 1);
      CLcount += 2;
    }
    else if (0 == strncmp (av[CLcount], "-mvf", 3) || 0 == strncmp (av[CLcount], "-MVF", 3))  // A file parameter?
    {

      conf_read_check (sscanf(av[CLcount+1],"%d", &p_Inp->mv_flag), 1);
      CLcount += 2;
    }
